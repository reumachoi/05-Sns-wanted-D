...
😆배포 완료 : http://3.37.247.8/api (현재 배포 중단했습니다.)

## 프로젝트 진행 기간
1차 개발기간: `2022.07.20 ~ 07.26` <br/>
2차 추가 개발기간: `2022.07.27 ~ 07.31` <br/>
3차 추가 개발기간: `2022.08.01 ~ 08.11`
...
- 1차 개발기간 : 요구사항 기능 구현
- 2차 개발기간 : 미완료 요구사항 기능 추가 구현, 테스트 코드 작성, 스웨거 작성, 유효성 검사
- 3차 개발기간 : CI/CD
